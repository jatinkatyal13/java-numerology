 ...
 * @author Student
 */
public class pers_num1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblhead.setText("Personality Number");
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(destiny_num, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
        ...
        lblhead1.setText("Personality Number");
...
this.setVisible(false);
 ...
 int num=person.person_num;
 lblhead.setText(" Your Personality Number "+ num);
    String pers1="The person is dignified, outstanding, welldressed and impressive. A likeable personality."+
            "He/She likes to furnish his home properly.";
    String pers2="The person is pleasing, gentle and pays much attention to exct details in everything, "+
            "sometimes being fussy. He/she likes to wear neat, easy and plain clothes and needs to cultivate style.";

    String pers3="The person is talkative, friendly and artistic in expression. He/she likes to wear fancy clothes,"+
            "jewellery and sometimes dresses more than necessary and showy.";
    String pers4= "The person is serious and practical with properly fitting "+
            "and neat dresses. Care should be taken to avoid over dressing..";
    String pers5="The person is modern in his dress and is generally found to"+
    "wear well tailored and ultra modern clothes. He/She should avoid boastful"+
             "talk and expression and try to be more sober in his conversation.";
    String pers6="The person is sympathetic and compassionate in his talk and behaviour. "+
            "Does not pay attention to details in dressing, may be found casually are"+
            "shabbily dressed out of style. Needs improvement for better disposition.  .";
    String pers7="The person has a charming personality with a proper sense of dress and "+
            "impressive manners. Generally friendly and likeable but reserved in his talk unless acquainted..";
    String pers8="The person is normally well dressed with heavy or sporty clothing and gives the impression of"+
            "an executive with a showmanship. He/She is friendly and optimistic in talks..";
    String pers9="The person is friendly, warm, generous, young looking and gains success through "+
            "his/her dress in all colours except black which should be avoided. Sometimes easily dressed "+
            "like a 6, he/she attracts people through his/her pleasing manners. Although he/she has a magnetic personality he/she may appear distant because of whims or if interest is lacking. .";
    switch(num)
    {
        case 1: lblname.setIcon(new ImageIcon("src/1.jpg"));
                descarea.setText(pers1);
                break;
        case 2: lblname.setIcon(new ImageIcon("src/2.jpg"));
                descarea.setText(pers2);
                break;
        case 3: lblname.setIcon(new ImageIcon("src/3.jpg"));
                descarea.setText(pers3);
                break;
        case 4: lblname.setIcon(new ImageIcon("src/4.jpg"));
                descarea.setText(pers4);
                break;
        case 5: lblname.setIcon(new ImageIcon("src/5.jpg"));
                descarea.setText(pers5);
                break;
        case 6: lblname.setIcon(new ImageIcon("src/6.jpg"));
                descarea.setText(pers6);
                break;
        case 7: lblname.setIcon(new ImageIcon("src/7.jpg"));
                descarea.setText(pers7);
                break;
        case 8: lblname.setIcon(new ImageIcon("src/8.jpg"));
                descarea.setText(pers8);
                break;
        case 9: lblname.setIcon(new ImageIcon("src/9.jpg"));
                descarea.setText(pers9);
                break;
       }
